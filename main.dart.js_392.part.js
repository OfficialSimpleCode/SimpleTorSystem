...
$__dart_deferred_initializers__.current=function(a,b,c,$){var A,C,B={dCo:function dCo(){this.a=null}}
A=c[0]
C=c[2]
...
y=Date.now()
y=A.u(w,x).a2(A.u(w,x).t(new A.L(y,0,!1)),!1,!1)
A.T(0,1,1,0,0,0,0,0)
A.T(0,1,1,0,0,0,0,0)
v=new A.ej(C.o4,y,v)}return v}}
